...
var ddaccordion = {
    ...
    expandit: function ($targetHeader, $targetContent, config, useractivated, directclick, skipanimation, scrolltoheader) {
        ...
        $targetHeader.parent("div").addClass("actived");
        $targetContent.css("display", "block");
        //        $targetContent.animate({ height: contentheight, opacity: '0.4' }, "slow", function () {
        //            if (scrolltoheader) {
    ...
    collapseit: function ($targetHeader, $targetContent, config, isuseractivated) {
        ...
        $targetHeader.parent("div").removeClass("actived");
        //$targetContent.animate({ height: 0, opacity: '0.4' }, "slow");
